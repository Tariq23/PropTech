...
const PortalSidebar = ({ open, setOpen }) => {
  const location = useLocation();

  const navigation = [
    { name: 'Dashboard', href: '/portal/dashboard', icon: HomeIcon },
    { name: 'Properties', href: '/portal/properties', icon: BuildingOfficeIcon },
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div className="flex-shrink-0 flex items-center px-4">
                <span className="text-xl font-bold text-primary-600">PropTech Portal</span>
              </div>
